...
DATA.generate_analytical_pattern(input_parameters) # pattern index 0 with -3 dB efficiency
...
brightness_model={'type': 'cone', 'temperature': 290, 'diameter': 70, 'direction': [0, 0]}
